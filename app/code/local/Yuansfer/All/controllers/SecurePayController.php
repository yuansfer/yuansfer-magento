...
class Yuansfer_All_SecurePayController extends Mage_Core_Controller_Front_Action
{
    public function redirectAction()
    {
        $this->getResponse()->setBody($this->getLayout()->createBlock('yuansfer_all/securepay_yuansferform')->toHtml());
    }
