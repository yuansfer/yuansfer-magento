...
class Yuansfer_Block_Securepay_Yuansferform extends Mage_Core_Block_Abstract
{
    ...
    protected function _toHtml()
    {
        ...
        $vendor = '';
        if ($methodCode == Yuansfer_Model_MethodAbstract::CODE_ALIPAY) {
            $vendor = 'alipay';
        } elseif ($methodCode == Yuansfer_Model_MethodAbstract::CODE_UNIONPAY) {
            $vendor = 'unionpay';
        } elseif ($methodCode == Yuansfer_Model_MethodAbstract::CODE_WECHATPAY) {
            $vendor = 'wechatpay';
        }
